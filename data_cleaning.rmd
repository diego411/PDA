...
All but one listing have a non-zero number of reviews and non-null values for reviews_per_month, which suggests they are legitimate listings with recent activity.

Remove the implausible listing and change the price for the others to NA.
