...
earningsplot_df %>%
  ...
  labs(
    title = "Cumulated Earnings of upper 6% and lower 94% of Monthly Earnings Distribution",
...
earningsplot_df %>%
  ...
  geom_bar(stat = "identity",
           show.legend = FALSE) +
  coord_polar("y") +
  labs(title = "Cumulated Monthly Earnings of upper 6% and lower 94%") +
  theme_void() + 
...
Examining average characteristics determining earnings conveys that hosts profit from a high utilization rate. 
