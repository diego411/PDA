...
df$name_length <- nchar(str_replace_all(df$name, " ", "")) 
summary(df$name_length)
```

Plot the number of characters in histogram using bins of size 10: 
...
df %>% filter(name_length > 42)
df %>% filter(name_length < 20)
```
...
##  Word occurence and sentiment analysis
